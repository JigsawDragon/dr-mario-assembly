...
I used the Saturn IDE, which was the recommended IDE due to its adaptable nature and the fact that it is newer compared to its ancient alternative, MARS. This IDE has been created by a student soon to graduate and it is a fantastic and comfortable IDE for assembly coding. If you'd like to run this code you can download either of the 2 above IDEs and open the .asm file on it.
